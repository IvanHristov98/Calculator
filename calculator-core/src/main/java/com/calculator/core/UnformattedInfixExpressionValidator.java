...
public class UnformattedInfixExpressionValidator extends ExpressionFilter
{
    ...
    private void validateIfAnyNumbersAreGluedAroundBracketedExpression(String expressionContent) throws BracketsException
    {
    ...
    private void validateExpressionBeforeClosingBrackets(String expressionContent) throws OperatorMisplacementException
    {
