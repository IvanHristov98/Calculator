...
public class CalculatorFactory {
	...
	public ICalculator makeCalculator() {
		...
		InfixToPostfixExpressionTranslator postfixTranslator = makeInfixToPostfixExpressionTranslator(tokenSplitter,
				numberChecker);

		InfixExpressionFilter infixFilter = makeInfixExpressionFilter(infixValidator, infixFormatter,
				postfixTranslator);
	...
	private UnformattedInfixExpressionValidator makeUnformattedInfixExpressionValidator(
	...
	private InfixToPostfixExpressionTranslator makeInfixToPostfixExpressionTranslator(
			ExpressionTokenSplitter tokenSplitter, NumberChecker numberChecker) {
		return new InfixToPostfixExpressionTranslator(tokenSplitter, numberChecker);
	}

	private InfixExpressionFilter makeInfixExpressionFilter(UnformattedInfixExpressionValidator infixValidator,
	...
	private PostfixExpressionCalculator makePostfixExpressionCalculator(ExpressionTokenSplitter tokenSplitter,
